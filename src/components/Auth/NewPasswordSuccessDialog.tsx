...
interface NewPasswordSuccessDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export default function NewPasswordSuccessDialog({ open, onOpenChange }: NewPasswordSuccessDialogProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <Button
          asChild
          className="bg-[#4397ae] hover:bg-[#4397ae]/90 mt-4 px-6 py-2.5 rounded-[30px] w-full text-white text-lg h-auto transition-colors cursor-pointer"
        >
