...
const CATEGORY_GRADIENTS: Record<string, string> = {
  ...
  pancake: "from-[#f4a851]/20 to-[#c97d2a]/20",
  waffle: "from-[#f4a851]/20 to-[#c97d2a]/20",
  crepe: "from-[#f4a851]/20 to-[#c97d2a]/20",
  pizza: "from-[#f4a851]/20 to-[#c97d2a]/20",
  molten: "from-[#f4a851]/20 to-[#c97d2a]/20",
...
> = {
  ...
  pancake: {
    ...
    href: "/menu/order/pancake",
  },
  waffle: {
    image: waffle,
    sublabel: "نوتيلا · لوتس · بيستاشيو · مكسات",
    href: "/menu/order/waffle",
  },
  crepe: {
    image: crepe,
    sublabel: "نوتيلا · لوتس · بيستاشيو · مكسات",
    href: "/menu/order/crepe",
  },
  pizza: {
    image: glassyPizza,
    sublabel: "نوتيلا · لوتس · بيستاشيو · مكسات",
    href: "/menu/order/pizza",
  },
  molten: {
    image: moltenCake,
    sublabel: "نوتيلا · لوتس · بيستاشيو · مكسات",
