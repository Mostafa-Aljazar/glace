    ...
    return (
      <div className="relative bg-[radial-gradient(circle,#41a2c5_0%,#388dab_100%)] min-h-screen overflow-x-hidden">
        ...
        <div className="z-90 relative flex flex-col justify-center items-center gap-6 mx-auto px-4 pt-20 max-w-300 text-white text-center">
          ...
          <Button
            asChild
            className="bg-[#117291] hover:bg-[#0e6080] px-8 py-3 rounded-[30px] text-white text-[20px] h-auto"
          >
              ...
              {delivery === "delivery" && (
                <Form {...form}>
                  ...
                  >
                    ...
                    <Button
                      type="submit"
                      className="bg-[#117291] hover:bg-[#0e6080] border-0 rounded-[30px] w-full text-white text-[20px] h-auto py-3 mt-2 cursor-pointer"
                    >
                      تأكيد وانتقل للدفع
                    </Button>
                  </form>
              ...
              {delivery === "pickup" && (
                <div className="text-white">
                  <p className="mb-4 text-[18px]">
                    سيتم استلام طلبك من المحل مباشرة.
                  </p>
                  <Button
                    type="button"
          ...
          <div className="lg:w-[300px] w-full">
            <div className="bg-white/[.17] backdrop-blur-[15px] rounded-[30px] p-6 text-white">
              ...
              <div className="flex flex-col gap-2 mb-4 max-h-[250px] overflow-y-auto">
                ...
                {cartAddonTotal > 0 && (
                  <div className="flex justify-between text-[15px] border-b border-white/20 pb-2 text-glace-yellow">
                    <span>
                      إضافات السلة
                      {cartAddons.length > 0
                        ? ` (${cartAddons.join(" · ")})`
                    ...
                    <span>+{cartAddonTotal.toFixed(2)} ₪</span>
                  </div>
                )}
              </div>

              <div className="flex justify-between mb-2 text-[15px] text-white/80">
