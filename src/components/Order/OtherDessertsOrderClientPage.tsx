...
import { iceCreamKunafa, moltenCake, browniesCake, mochi, sanSebastian } from "@/assets/images";
...
export default function OtherDessertsOrderClientPage({ initialType = "kunafa" }: { initialType?: string }) {
