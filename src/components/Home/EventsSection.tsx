...
function EmptyEvents() {
  return (
    <div className="flex flex-col items-center gap-3 bg-glace-brown/4 mx-auto py-14 sm:py-16 border border-glace-brown/10 rounded-[24px] w-full text-center">
      <div className="flex justify-center items-center bg-glace-brown/10 rounded-full size-16">
        <CalendarX className="size-8 text-glace-brown" strokeWidth={1.5} />
      </div>
      <h3 className="font-bold text-glace-brown text-xl">
        لا توجد فعاليات حالياً
      </h3>
      <p className="px-6 max-w-sm text-glace-brown/60 text-[15px] leading-relaxed">
        تابعونا لمعرفة أحدث فعاليات ومناسبات جلاسيه الأمير
      </p>
    </div>
  );
}
